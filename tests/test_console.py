...
class TestConsoleClass(unittest.TestCase):
    ...
    def test_update_missing_name(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('create BaseModel')
    ...
    def test_existance_create2(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            ...
            self.assertTrue("California" in id_output.getvalue())
    ...
    def test_create_underscore_st(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('all State')
            self.assertTrue("California is life" in id_output.getvalue())
    ...
    def test_create_float_st(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('all State')
            self.assertTrue("2.5" in id_output.getvalue())
    ...
    def test_create_int_st(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('all State')
            self.assertTrue("500" in id_output.getvalue())
    ...
    def test_create_error_int(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('all State')
            self.assertTrue("5055m" not in id_output.getvalue())
    ...
    def test_create_error_float(self):
        ...
        with patch('sys.stdout', new=StringIO()) as id_output:
            HBNBCommand().onecmd('all State')
            self.assertTrue("hello.world" not in id_output.getvalue())
